...
class __TwigTemplate_cabb2e99fb24a858d65e5281087744c35e1c81c1c13f60d9ff74942b9e9f086c extends Twig_Template
{
...
";
        ...
        ";
            ...
            // line 6
            echo "        ";
            if ( !$this->getAttribute($this->getAttribute((isset($context["grav"]) ? $context["grav"] : null), "uri", array()), "param", array(0 => "hidepagetitle"), "method")) {
                // line 7
                echo "          ";
...
";
    ...
    <div class=\"e-content\">
        ...
        // line 18
        echo "        ";
        if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "parent", array()), "header", array()), "display_post_summary", array()), "enabled", array())) {
            // line 19
            echo "          ";
            ...
            // line 21
            echo "          ";
            $context["content"] = $this->getAttribute((isset($context["page"]) ? $context["page"] : null), "content", array());
            // line 22
            echo "        ";
        }
        // line 23
        ...
        // line 25
        echo "        ";
        if ( !$this->getAttribute($this->getAttribute((isset($context["grav"]) ? $context["grav"] : null), "uri", array()), "param", array(0 => "summaryonly"), "method")) {
            // line 26
            echo "            ";
...
{% endif %}
", "partials/blog-item.html.twig", "/Users/jerrybrahm/repos/blog/user/themes/quark-open-publishing/templates/partials/blog-item.html.twig");
    }
}
