...
class __TwigTemplate_b090616004501190974f0c0a2cd1b4bbe9b5f3580fe8a1298968bd970273a48f extends Twig_Template
{
...
";
            ...
            // line 10
            echo "    ";
            if ($this->getAttribute($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "header", array()), "post_icon", array())) {
                // line 11
                echo "      ";
                $context["titleicon"] = $this->getAttribute($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "header", array()), "post_icon", array());
                // line 12
                echo "    ";
            } else {
                // line 13
                ...
                // line 16
                echo "      ";
                if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "parent", array()), "header", array()), "post_icon", array())) {
                    // line 17
                    echo "        ";
                    $context["titleicon"] = $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "parent", array()), "header", array()), "post_icon", array());
                    // line 18
                    echo "      ";
                }
                // line 19
            ...
            if ( !$this->getAttribute($this->getAttribute((isset($context["grav"]) ? $context["grav"] : null), "uri", array()), "param", array(0 => "hidepagetitle"), "method")) {
                // line 21
                echo "      ";
                if ((isset($context["titleicon"]) ? $context["titleicon"] : null)) {
                    // line 22
                    echo "        <";
                    echo (isset($context["title_level"]) ? $context["title_level"] : null);
                    ...
                    echo (isset($context["titleicon"]) ? $context["titleicon"] : null);
...
{% else %}
    ...
    {% endif %}
{% endif %}
", "partials/blog/title.html.twig", "/Users/jerrybrahm/repos/blog/user/themes/quark-open-publishing/templates/partials/blog/title.html.twig");
    }
}
